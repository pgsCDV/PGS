...
public class NewMove : MonoBehaviour
{
    ...
    // From Movement
    public float gravity = -9.81f; // Not directly used with Rigidbody, but for calculations
    public float jumpHeight = 2f; // Used to compute jumpForce
    ...
    void Awake()
    {
        ...
        // Compute jumpForce from jumpHeight (adjusted for Rigidbody)
        jumpForce = Mathf.Sqrt(jumpHeight * -2f * Physics.gravity.y); // Assuming mass=1
    }
